...
import "@/app/shared/pages/aa4b54730b53.css";
import type { Metadata } from "next";
import { notFound } from "next/navigation";
import type { ComponentType } from "react";
import MentalHealthTherapy from "@/components/templates/MentalHealthTherapy";
...
const PREFIX = "/mental-health/therapy";
const FALLBACK_SLUGS = ["how-much-does-emdr-therapy-cost","difference-between-dbt-and-cbt","look-for-in-a-residential-treatment-center","goal-of-therapy-2","mental-health-treatment-important","when-to-go-to-therapy","why-do-people-go-to-therapy","what-to-pack-inpatient-mental-health-treatment","what-is-inpatient-mental-health","elements-of-therapy","benefits-of-therapy","benefits-of-counseling","mental-health-services-adults","motivational-interviewing-techniques","mental-health-rehab","how-to-find-a-therapist","is-emdr-evidence-based","misconceptions-about-therapy","how-much-does-therapy-cost","dynamic-interpersonal-therapy"] as string[];
...
export async function generateStaticParams() {
  ...
  try {
    const res = await fetch(
      `${wpUrl}/wp-json/builder/v1/pages?path=%2Fmental-health%2Ftherapy`,
...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const Template: ComponentType<Record<string, string>> = (await resolveTemplate(data)) ?? MentalHealthTherapy;
