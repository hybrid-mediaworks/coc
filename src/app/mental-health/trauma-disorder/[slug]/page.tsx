...
import MentalHealthTraumaDisorder from "@/components/templates/MentalHealthTraumaDisorder";
...
const PREFIX = "/mental-health/trauma-disorder";
const FALLBACK_SLUGS = ["mental-health-and-gun-violence","what-is-anorexia-nervosa","how-to-help-someone-who-self-harms","signs-of-ptsd","betrayal-trauma","how-does-trauma-affect-the-brain","healing-from-childhood-trauma","enmeshment-trauma"] as string[];
...
export async function generateStaticParams() {
  ...
  try {
    const res = await fetch(
      `${wpUrl}/wp-json/builder/v1/pages?path=%2Fmental-health%2Ftrauma-disorder`,
...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const Template: ComponentType<Record<string, string>> = (await resolveTemplate(data)) ?? MentalHealthTraumaDisorder;
