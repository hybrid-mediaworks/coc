...
import "@/app/shared/pages/81e7d19fa459.css";
import type { Metadata } from "next";
import { notFound } from "next/navigation";
import type { ComponentType } from "react";
import MentalHealthMoodDisordersBipolar from "@/components/templates/MentalHealthMoodDisordersBipolar";
...
const PREFIX = "/mental-health/mood-disorders/bipolar";
const FALLBACK_SLUGS = ["social-rhythm-therapy","how-to-help-someone-with-bipolar-disorder","how-a-person-with-bipolar-thinks","bipolar-disorder-saying-hurtful-things","bipolar-anger","help-someone-bipolar-depression","hypomania","cyclothymia"] as string[];
...
export async function generateStaticParams() {
  ...
  try {
    const res = await fetch(
      `${wpUrl}/wp-json/builder/v1/pages?path=%2Fmental-health%2Fmood-disorders%2Fbipolar`,
...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const Template: ComponentType<Record<string, string>> = (await resolveTemplate(data)) ?? MentalHealthMoodDisordersBipolar;
