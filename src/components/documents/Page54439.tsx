...
export default function Page54439(props: Record<string, string>) {
  ...
  return (
    <>
    <div className="wp-singular page-template-default page page-id-54630 wp-embed-responsive wp-theme-hello-elementor facilit-gallery--empty hello-elementor-default elementor-default elementor-kit-6 elementor-page-54439">
  ...
  <div className="elementor elementor-54439 elementor-location-single post-54630 page type-page status-publish hentry page_template_type-cro1">
    <div className="elementor-element elementor-element-5e166ce6 e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-2552ca4f e-con-full e-flex e-con e-child" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}"></div>
      <div className="elementor-element elementor-element-5e965ffa e-con-full e-flex e-con e-child" data-settings="{&quot;background_background&quot;:&quot;gradient&quot;}">
        <div className="elementor-element elementor-element-77f6763 e-flex e-con-boxed e-con e-child">
          <div className="e-con-inner">
            ...
            <div className="elementor-element elementor-element-7d9e7522 e-con-full e-flex e-con e-child">
              ...
              <div className="elementor-element elementor-element-6519b96c e-con-full e-flex e-con e-child">
                <div className="elementor-element elementor-element-50b0ff7e elementor-widget elementor-widget-heading" data-widget_type="heading.default">
                  <div className="elementor-widget-container">
                ...
                <div className="elementor-element elementor-element-40d815fb elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-widget_type="icon-list.default">
                  <div className="elementor-widget-container">
              ...
              <div className="elementor-element elementor-element-76668789 e-con-full e-flex e-con e-child">
                <div className="elementor-element elementor-element-61d4e39 elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button" data-widget_type="button.default">
                  <div className="elementor-widget-container">
                ...
                <div className="elementor-element elementor-element-f5d4024 elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button" data-widget_type="button.default">
                  <div className="elementor-widget-container">
                    <div className="elementor-button-wrapper">
              ...
              <div className="elementor-element elementor-element-dde9be5 e-con-full e-flex e-con e-child">
                <div className="elementor-element elementor-element-d92553d elementor-author-box--align-left elementor-author-box--image-valign-middle elementor-widget__width-initial elementor-widget-mobile__width-auto author-box-sty elementor-widget elementor-widget-author-box" data-widget_type="author-box.default">
                  <div className="elementor-widget-container">
                ...
                <div className="elementor-element elementor-element-918b985 elementor-author-box--align-left elementor-author-box--image-valign-middle elementor-widget__width-auto elementor-widget-mobile__width-initial author-box-sty elementor-widget elementor-widget-author-box" data-widget_type="author-box.default">
                  <div className="elementor-widget-container">
                    <div className="elementor-author-box">
                      <div className="elementor-author-box__avatar">
                        <Image src="/images/041644d05bb1884e01e4d67ff21f7af4.webp" alt="Picture of Content Manager:" width={240} height={240} className="entered error" />
                      </div>
                      <div className="elementor-author-box__text">
                        <div>
                          <h6 className="elementor-author-box__name" style={{"fontSize":"20px"}}>
                ...
                <div className="elementor-element elementor-element-eb76ea4 elementor-author-box--align-left elementor-author-box--image-valign-middle elementor-widget__width-auto author-box-sty elementor-widget elementor-widget-author-box" data-widget_type="author-box.default">
                  <div className="elementor-widget-container">
                    <div className="elementor-author-box">
                      <div className="elementor-author-box__avatar">
                        <Image src="/images/51da16cd23104684a16769a1a387eb3b.webp" alt="Picture of Editor:" width={240} height={240} className="entered error" />
                      </div>
                      <div className="elementor-author-box__text">
                        <div>
                          <h6 className="elementor-author-box__name" style={{"fontSize":"20px"}}>
              ...
              <div className="elementor-element elementor-element-62089ff1 e-con-full e-flex e-con e-child">
                <div className="elementor-element elementor-element-691f91f2 e-con-full e-flex e-con e-child">
                  <div className="elementor-element elementor-element-548cf3be elementor-widget elementor-widget-image" data-widget_type="image.default">
                    <div className="elementor-widget-container">
                      <Image src="/images/cbe1ff6e680ff2a501fe36fc8f2b7500.webp" alt="" width={95} height={90} className="attachment-full size-full wp-image-54407 entered error" />
                    </div>
                  </div>
                  <div className="elementor-element elementor-element-65c1c890 elementor-widget elementor-widget-image" data-widget_type="image.default">
                    <div className="elementor-widget-container">
                      <Image src="/images/3aca933a3c6e29944faab39776f794b5.webp" alt="" width={83} height={90} className="attachment-full size-full wp-image-54408 entered error" />
                    </div>
                  </div>
                  <div className="elementor-element elementor-element-1fa9838d elementor-widget elementor-widget-image" data-widget_type="image.default">
                    <div className="elementor-widget-container">
                      <Image src="/images/271622d5800857b84c5ffae18c6b99e1.webp" alt="" width={103} height={90} className="attachment-full size-full wp-image-54409 entered error" />
                    </div>
                  </div>
                </div>
              </div>
    ...
    {__hasData(["h2___head"]) ? (
<div className="elementor-element elementor-element-66eb7d7a table-of-content-headings e-flex e-con-boxed e-con e-parent e-lazyloaded">
      <div className="e-con-inner">
        <div className="elementor-element elementor-element-6d31a126 e-con-full e-flex e-con e-child">
          <div className="elementor-element elementor-element-5f8fc2df table-of-content-sty elementor-widget elementor-widget-table-of-contents" data-settings="{&quot;headings_by_tags&quot;:[&quot;h2&quot;],&quot;exclude_headings_by_selector&quot;:[],&quot;no_headings_message&quot;:&quot;No headings were found on this page.&quot;,&quot;container&quot;:&quot;.table-of-content-headings&quot;,&quot;marker_view&quot;:&quot;numbers&quot;,&quot;hierarchical_view&quot;:&quot;yes&quot;,&quot;min_height&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:&quot;&quot;,&quot;sizes&quot;:[]},&quot;min_height_tablet&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:&quot;&quot;,&quot;sizes&quot;:[]},&quot;min_height_mobile&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:&quot;&quot;,&quot;sizes&quot;:[]}}" data-widget_type="table-of-contents.default">
            <div className="elementor-widget-container">
              ...
              <div id="elementor-toc__5f8fc2df" className="elementor-toc__body">
                <ol className="elementor-toc__list-wrapper">
                  ...
                  <li className="elementor-toc__list-item">
                    <div className="elementor-toc__list-item-text-wrapper">
                      <a href="#elementor-toc__heading-anchor-4" className="elementor-toc__list-item-text elementor-toc__top-level">
                        The Safer Detox Option: Medical Detox
                      </a>
                    </div>
                  </li>
                  <li className="elementor-toc__list-item">
                  ...
                  <li className="elementor-toc__list-item">
                    <div className="elementor-toc__list-item-text-wrapper">
                      <a href="#elementor-toc__heading-anchor-6" className="elementor-toc__list-item-text elementor-toc__top-level elementor-item-active">
                        Get a Safe Medical Detox from Alcohol at Gratitude Lodge
                      </a>
                    </div>
                  </li>
                  <li className="elementor-toc__list-item">
        ...
        <div className="elementor-element elementor-element-7a42b48f e-con-full e-flex e-con e-child">
          <div className="elementor-element elementor-element-b9a89f3 elementor-widget elementor-widget-heading" data-widget_type="heading.default">
            <div className="elementor-widget-container">
    ...
    {__present("11765fd") ? (
<div className="elementor-element elementor-element-11765fd e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-b193046 elementor-widget elementor-widget-template" data-widget_type="template.default">
        <div className="elementor-widget-container">
          <div className="elementor-template">
            <div className="elementor elementor-54588">
              <div className="elementor-element elementor-element-7b995ec1 addiction-care-cta-v1-section e-flex e-con-boxed e-con e-parent e-lazyloaded" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                <div className="e-con-inner">
                  <div className="elementor-element elementor-element-38726823 e-con-full e-flex e-con e-child" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                    ...
                    <div className="elementor-element elementor-element-3782fdbc elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-widget_type="divider.default">
                      <div className="elementor-widget-container">
                        <div className="elementor-divider"></div>
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-5276641d e-con-full e-flex e-con e-child">
                      <div className="elementor-element elementor-element-4f971625 elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button" data-widget_type="button.default">
                        <div className="elementor-widget-container">
                          <div className="elementor-button-wrapper">
                      ...
                      <div className="elementor-element elementor-element-3e5606f elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button" data-widget_type="button.default">
                        <div className="elementor-widget-container">
                          <div className="elementor-button-wrapper">
                      ...
                      <div className="elementor-element elementor-element-889a4d0 elementor-align-justify elementor-widget-mobile__width-inherit elementor-widget elementor-widget-button" data-widget_type="button.default">
                        <div className="elementor-widget-container">
                          <div className="elementor-button-wrapper">
                            <Link className="elementor-button elementor-button-link elementor-size-sm" href="tel:844-576-0144" style={{"fontSize":"16px"}}>
                              <span className="elementor-button-content-wrapper" style={{"fontSize":"16px"}}>
...
<div className="elementor-element elementor-element-59f28e2 table-of-content-headings empty-container-sty e-flex e-con-boxed e-con e-parent e-lazyloaded">
      <div className="e-con-inner">
        <div className="elementor-element elementor-element-66c2e4ca cro-bog-content-sty elementor-widget elementor-widget-text-editor" data-widget_type="text-editor.default">
          <div className="elementor-widget-container">
    ...
    <div className="elementor-element elementor-element-2382d17 e-con-full elementor-hidden-desktop elementor-hidden-tablet elementor-hidden-mobile e-flex e-con e-parent">
      <div className="elementor-element elementor-element-55befcc elementor-widget elementor-widget-template" data-widget_type="template.default">
        <div className="elementor-widget-container">
          <div className="elementor-template">
                    ...
                    <div className="elementor-element elementor-element-7dc87a1d elementor-widget elementor-widget-loop-carousel e-widget-swiper" data-settings="{&quot;template_id&quot;:&quot;54492&quot;,&quot;image_spacing_custom&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:48,&quot;sizes&quot;:[]},&quot;image_spacing_custom_tablet&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:24,&quot;sizes&quot;:[]},&quot;_skin&quot;:&quot;post&quot;,&quot;slides_to_show&quot;:&quot;3&quot;,&quot;slides_to_show_tablet&quot;:&quot;2&quot;,&quot;slides_to_show_mobile&quot;:&quot;1&quot;,&quot;slides_to_scroll&quot;:&quot;1&quot;,&quot;edit_handle_selector&quot;:&quot;.elementor-loop-container&quot;,&quot;autoplay&quot;:&quot;yes&quot;,&quot;autoplay_speed&quot;:5000,&quot;pause_on_hover&quot;:&quot;yes&quot;,&quot;pause_on_interaction&quot;:&quot;yes&quot;,&quot;infinite&quot;:&quot;yes&quot;,&quot;speed&quot;:500,&quot;offset_sides&quot;:&quot;none&quot;,&quot;image_spacing_custom_mobile&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:&quot;&quot;,&quot;sizes&quot;:[]}}" data-widget_type="loop-carousel.post">
                      <div className="elementor-widget-container">
                        <div className="swiper elementor-loop-container elementor-grid swiper-initialized swiper-horizontal swiper-pointer-events" role="list" dir="ltr">
                          <div className="swiper-wrapper" aria-live="off" style={{"transitionDuration":"0ms","transform":"none"}} id="swiper-wrapper-2ff94f278bf5cc96">
    ...
    <div className="elementor-element elementor-element-672c15c e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-dc0495a elementor-widget elementor-widget-template" data-widget_type="template.default">
        <div className="elementor-widget-container">
          <div className="elementor-template">
    ...
    <div className="elementor-element elementor-element-1f6d9ab e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-1250f14 elementor-widget elementor-widget-template" data-widget_type="template.default">
        <div className="elementor-widget-container">
          <div className="elementor-template">
                  ...
                  <div className="elementor-element elementor-element-db5b86e elementor-arrows-position-outside img-carousel-sty elementor-pagination-position-outside elementor-widget elementor-widget-image-carousel e-widget-swiper" data-settings="{&quot;slides_to_show&quot;:&quot;3&quot;,&quot;image_spacing_custom&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:48,&quot;sizes&quot;:[]},&quot;image_spacing_custom_tablet&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:24,&quot;sizes&quot;:[]},&quot;navigation&quot;:&quot;both&quot;,&quot;autoplay&quot;:&quot;yes&quot;,&quot;pause_on_hover&quot;:&quot;yes&quot;,&quot;pause_on_interaction&quot;:&quot;yes&quot;,&quot;autoplay_speed&quot;:5000,&quot;infinite&quot;:&quot;yes&quot;,&quot;speed&quot;:500,&quot;image_spacing_custom_mobile&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:&quot;&quot;,&quot;sizes&quot;:[]}}" data-widget_type="image-carousel.default">
                    <div className="elementor-widget-container">
                      <div className="elementor-image-carousel-wrapper swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden" role="region" aria-roledescription="carousel" aria-label="Image Carousel" dir="ltr">
                        ...
                        <div className="elementor-swiper-button elementor-swiper-button-next" role="button" tabIndex={0} aria-label="Next slide" aria-controls="swiper-wrapper-52e6752b13610591f">
    ...
    <div className="elementor-element elementor-element-3ea2e67 e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-7824265 elementor-widget elementor-widget-template" data-widget_type="template.default">
        <div className="elementor-widget-container">
          <div className="elementor-template">
    ...
    <div className="elementor-element elementor-element-ba036d0 e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-2c3a25e elementor-widget elementor-widget-template" data-widget_type="template.default">
        <div className="elementor-widget-container">
          <div className="elementor-template">
    ...
    <div className="elementor-element elementor-element-a3a2c22 e-flex e-con-boxed e-con e-parent e-lazyloaded" data-settings="{&quot;background_background&quot;:&quot;gradient&quot;}">
      <div className="e-con-inner">
        <div className="elementor-element elementor-element-65c2ca6 elementor-widget elementor-widget-heading" data-widget_type="heading.default">
          <div className="elementor-widget-container">
            <h2 className="elementor-heading-title elementor-size-default" style={{"fontSize":"32px"}}>
              Related Pages
            </h2>
    ...
    <div className="elementor-element elementor-element-774dd91 e-con-full e-flex e-con e-parent e-lazyloaded">
      <div className="elementor-element elementor-element-27e975b elementor-widget elementor-widget-template" data-widget_type="template.default">
        <div className="elementor-widget-container">
          <div className="elementor-template">
